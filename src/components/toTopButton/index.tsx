...
const ToTop = () => {
    ...
    return (
        <svg onClick={() => window.scrollTo(0, 0)} className={`${topHeight > 1000 ? "md:right-[40px] right-[20px]": "right-[-60px]"} fixed md:bottom-[40px] bottom-[20px] md:w-[60px] w-[40px] md:h-[60px] h-[40px] cursor-pointer duration-[0.2s] hover:translate-y-[-10px]`} viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
