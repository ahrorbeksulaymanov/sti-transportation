    ...
    return (
        <div>
            <section className="purchase-first-block mt-[80px] mb-[110px]">
                ...
                <p data-aos="fade-up" className='lg:text-[22px] md:text-[20px] text-[12px] md:w-[736px] sm:w-[60%] w-[80%]  mx-auto text-center mt-[20px] leading-[132%]'>Welcome to our blog. Here you can keep in touch with us on a daily basis and by following our instagram and facebook pages you can be with us everyday and see how everything works</p>
            </section>
