                ...
                <div className='relative' data-aos="fade-up">
                    <div className='absolute xl:top-[21%] lg:top-[19%] md:top-[16%] sm:top-[15%] top-[13%] xl:right-[36%] lg:right-[37%] md:right-[39%] sm:right-[40%] right-[41%] rounded-[6px]' style={{boxShadow:"0px 2px 21px rgba(255, 255, 255, 0.1)", border:"1px solid rgba(255, 255, 255, 0.2)"}}>
                        ...
                        <div className='bg-[#141414] px-[13px] py-[15px] rounded-[6px] w-[227px] border-[1px] left-arrow' style={{borderColor:"rgba(255, 255, 255, 0.05)"}}>
                            ...
                            <a href='https://www.google.com/maps/place/4361+Teak+Cir,+Naperville,+IL+60564,+USA/@41.5011602,-88.3560431,10.26z/data=!4m5!3m4!1s0x880ef6c1bed0573f:0x2c906136d12a47cc!8m2!3d41.6897474!4d-88.2283194?coh=164777&entry=tt' target={'_blank'} className='text-[12px] font-[400] bg-orange hover:bg-orange_hover rounded-[7px] w-[100%] py-[10px] mt-[10px] text-center inline-block'>Go to map</a>
                        </div>
                    </div>
