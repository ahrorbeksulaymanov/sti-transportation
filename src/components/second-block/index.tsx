...
const SecondBlock = () => {
    ...
    return (
        <section className="second-block lg:mt-[250px] md:mt-[100px] mt-[10px] text-white">
            ...
            <button data-aos="fade-up" data-aos-anchor-placement="center-bottom" className='learn-more-btn md:text-[16px] text-[12px] bg-[#EE3532] hover:bg-[#cb2c29] md:px-[51px] px-[22px] md:py-[14px] py-[12px] rounded-[100px] flex mx-auto font-[500] md:mt-[35px] mt-[51px]' style={{alignItems:"center"}}>LEARN MORE 
